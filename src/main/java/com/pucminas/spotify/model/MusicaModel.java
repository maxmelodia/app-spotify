 ...
 */
public class MusicaModel extends AbstractModelObject {
  ...
  private MusicaModel(final Builder builder) {
    super(builder);
  ...
  /**
   * Builder class for building {@link MusicaModel} instances.
   */
  public static final class Builder extends AbstractModelObject.Builder {
     ...
     * @return A {@link MusicaModel.Builder}.
     */
    ...
    @Override
    public MusicaModel build() {
      return new MusicaModel(this);
    }
  }

  /**
   * JsonUtil class for building {@link MusicaModel} instances.
   */
  public static final class JsonUtil extends AbstractModelObject.JsonUtil<MusicaModel> {
    public MusicaModel createModelObject(JsonObject jsonObject) {
